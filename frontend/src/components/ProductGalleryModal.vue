<template>
  <transition name="product-fade">
    ...
    >
      ...
      >
        <div
          class="relative w-full max-w-7xl overflow-hidden rounded-[28px] border border-[#f0e4e9] bg-white shadow-[0_24px_70px_rgba(0,0,0,0.20)]"
          :class="closing ? 'animate-product-out' : 'animate-product-in'"
        >
          <!-- Close -->
          <button
            @click="closeModal"
          ...
          <div class="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div class="relative lg:col-span-8 bg-[#f7f2f4] flex items-center justify-center">
              ...
              >
                <img
                  ...
                  :alt="currentImage.title || productTitle"
            ...
            >
              <div class="px-5 pt-5 pb-5 sm:px-6 sm:pt-6">
                ...
                <p
                  v-if="currentImage && currentImage.description"
                  class="mt-3 font-nunito text-[15px] leading-7 text-[#7d838d]"
                >
                  {{ currentImage.description }}
                </p>
                <p v-else class="mt-3 font-nunito text-[15px] leading-7 text-[#7d838d]">
                  Real customer before-and-after images for this You Glow Babe product.
                </p>
              </div>

              <!-- desktop thumbnails -->
              <div class="hidden lg:block px-5 sm:px-6 pb-6">
                <div class="product-thumb-scroll pr-1">
...
.animate-product-in {
  animation: productModalIn 0.24s ease-out forwards;
}

.animate-product-out {
  animation: productModalOut 0.2s ease-in forwards;
}
...
.product-thumb-scroll::-webkit-scrollbar-thumb {
  background: rgba(233, 122, 172, 0.32);
